...
/// <summary>
/// Schema contract tests for the archivist decision model. Verifies that
/// the JSON wire format matches the documented schema so downstream
/// consumers (promotion writer, loop-back, harness) can rely on the shape.
/// </summary>
