...
| **Edges / worklist / merge-group** | `EdgesCheckResult`, worklist build result, merge-group nesting decision result | `batch-integrator.ps1` (current implementation: `wave-integrator.ps1`), `batch-dispatch-guard.ps1`, root-workflow aggregation envelopes |
