...
[JsonSerializable(typeof(HierarchyResult[]))]
[JsonSerializable(typeof(JournalShowResult))]
[JsonSerializable(typeof(JournalShowFilters))]
...
[JsonSerializable(typeof(JournalHasResult))]
[JsonSerializable(typeof(JournalQueryResult))]
[JsonSerializable(typeof(JournalOwnedResult))]
[JsonSerializable(typeof(DriftResult))]
[JsonSerializable(typeof(DriftFinding))]
[JsonSerializable(typeof(DriftFinding[]))]
[JsonSerializable(typeof(DriftSummary))]
[JsonSerializable(typeof(ResetTargetDescriptor))]
[JsonSerializable(typeof(ResetTargetDescriptor[]))]
[JsonSerializable(typeof(FailedResetTargetDescriptor))]
[JsonSerializable(typeof(FailedResetTargetDescriptor[]))]
...
[JsonSerializable(typeof(BranchCloseScopePayload))]
...
[JsonSerializable(typeof(LineageAttachResult))]
[JsonSerializable(typeof(ReconcileResult))]
[JsonSerializable(typeof(ReconciledFinding))]
[JsonSerializable(typeof(ReconciledFinding[]))]
...
[JsonSerializable(typeof(PlanRebaseStaleDescendantPayload))]
[JsonSerializable(typeof(PlanRecreateStaleDescendantPayload))]
[JsonSerializable(typeof(WorktreeAddPayload))]
[JsonSerializable(typeof(WorktreeCreatePayload))]
[JsonSerializable(typeof(WorktreeRemovePayload))]
[JsonSerializable(typeof(WorktreeInitRootPayload))]
[JsonSerializable(typeof(WorktreeGcPayload))]
[JsonSerializable(typeof(ResetPrsPayload))]
[JsonSerializable(typeof(ResetWorktreesPayload))]
[JsonSerializable(typeof(ResetBranchesPayload))]
[JsonSerializable(typeof(ResetFacetsPayload))]
[JsonSerializable(typeof(ResetStatePayload))]
[JsonSerializable(typeof(ResetRootPayload))]
[JsonSerializable(typeof(PrCreateFeaturePrPayload))]
[JsonSerializable(typeof(PrCreateFeatureAdoPayload))]
[JsonSerializable(typeof(PrOpenPlanPrPayload))]
[JsonSerializable(typeof(PrOpenPlanAdoPayload))]
[JsonSerializable(typeof(PrOpenMergeGroupPrPayload))]
[JsonSerializable(typeof(PrOpenMergeGroupAdoPayload))]
[JsonSerializable(typeof(PrOpenImplPrPayload))]
[JsonSerializable(typeof(PrOpenImplAdoPayload))]
[JsonSerializable(typeof(PrOpenEvidencePrPayload))]
[JsonSerializable(typeof(PrOpenEvidenceAdoPayload))]
[JsonSerializable(typeof(PrMergePlanPrPayload))]
[JsonSerializable(typeof(PrMergePlanAdoPayload))]
[JsonSerializable(typeof(PrMergeMergeGroupPrPayload))]
[JsonSerializable(typeof(PrMergeMergeGroupAdoPayload))]
[JsonSerializable(typeof(PrMergeImplPrPayload))]
[JsonSerializable(typeof(PrMergeImplAdoPayload))]
[JsonSerializable(typeof(PrMergeEvidencePrPayload))]
[JsonSerializable(typeof(PrMergeEvidenceAdoPayload))]
[JsonSerializable(typeof(PrMergeFeatureAdoPayload))]
[JsonSerializable(typeof(PrPostCommentAdoPayload))]
[JsonSerializable(typeof(PrVoteAdoPayload))]
...
[JsonSerializable(typeof(PolicyUnattendedSnapshot))]
...
[JsonSerializable(typeof(BranchAssertOnImplResult))]
...
[JsonSerializable(typeof(PrOpenImplAdoResult))]
[JsonSerializable(typeof(PrOpenEvidenceResult))]
[JsonSerializable(typeof(PrOpenEvidenceAdoResult))]
[JsonSerializable(typeof(PrCheckEvidenceFloorResult))]
[JsonSerializable(typeof(PrMergeImplResult))]
[JsonSerializable(typeof(PrMergeImplAdoResult))]
[JsonSerializable(typeof(PrMergeEvidenceResult))]
[JsonSerializable(typeof(PrMergeEvidenceAdoResult))]
...
[JsonSerializable(typeof(WorktreeInitRootResult))]
[JsonSerializable(typeof(WorktreeCreateResult))]
...
[JsonSerializable(typeof(AdoAbandonPullRequestRequest))]
[JsonSerializable(typeof(AdoAuthStatus))]
[JsonSerializable(typeof(AdoCommitListEntry))]
[JsonSerializable(typeof(AdoCommitListResponse))]
...
[JsonSerializable(typeof(AdoEditPullRequestRequest))]
[JsonSerializable(typeof(AdoIterationChangeEntry))]
[JsonSerializable(typeof(AdoIterationChangeItem))]
[JsonSerializable(typeof(AdoIterationChangesResponse))]
[JsonSerializable(typeof(AdoIterationEntry))]
...
// Reset-family verbs (docs/decisions/run-reset.md)
[JsonSerializable(typeof(ResetStateResult))]
[JsonSerializable(typeof(ResetPrsResult))]
[JsonSerializable(typeof(ResetAbandonedPr))]
[JsonSerializable(typeof(ResetFailedPr))]
[JsonSerializable(typeof(ResetBranchesResult))]
[JsonSerializable(typeof(ResetDeletedBranch))]
[JsonSerializable(typeof(ResetFailedBranch))]
[JsonSerializable(typeof(ResetWorktreesResult))]
...
[JsonSerializable(typeof(ResetRootResult))]
[JsonSerializable(typeof(IReadOnlyList<ResetTargetDescriptor>))]
[JsonSerializable(typeof(IReadOnlyList<FailedResetTargetDescriptor>))]
[JsonSerializable(typeof(ResetStatePayload))]
[JsonSerializable(typeof(ResetPrsPayload))]
[JsonSerializable(typeof(ResetWorktreesPayload))]
[JsonSerializable(typeof(ResetBranchesPayload))]
